                ...
                {veiculo ? (
                    <div className="flex flex-col justify-center space-y-10">
                        <div className="flex flex-row items-center space-x-5 ">
                            <h2 className="text-[40px] font-semibold grow ">{veiculo.nome}</h2>
                            <button 
                            ...
                            >
                                ...
                                <svg className="w-[35px] h-auto fill-none" viewBox="0 0 26 26">
                                    <path 
                                        ...
                                        stroke="currentColor" strokeWidth="2.6087" strokeLinecap="round" strokeLinejoin="round"
                                    />
                                </svg>
                                <p>Editar Dados</p>
                            </button>
                        ...
                        <div className="flex flex-row grow items-start space-x-10">
                            ...
                            <div className="flex flex-col space-y-[25px] grow items-center">
                                <p className="font-extrabold text-[45px] mb-[-10px]">{veiculo.valor}</p>
                                <button 
                                    ...
                                    hover:bg-[#D9D9D9] hover:text-[#9A1C1F] hover:stroke-[#9A1C1F] ease-in-out transition-all duration-300"
                                >
                                    <svg className="w-[60px] h-auto fill-none " viewBox="0 0 44 40">
                                        <path 
                                ...
                                <div className="text-[20px] *:py-2 flex flex-col justify-center items-center space-y-[20px] bg-white w-[100%] px-[35px] py-[30px] rounded-2xl ">
                                    <div className="w-[100%]">
                                        ...
                                        <p className="font-extrabold text-[22px]">{veiculo.chassi}</p>
                                    </div>
                                    <div className="w-[100%]">
                                        <p className="font-medium">Ano/Modelo:</p>
                                        <p className="font-extrabold text-[22px]">{veiculo.ano_modelo}</p>
                                    </div>
                                    <div className="w-[100%]">
                                    ...
                                    <div className="w-[100%]">
                                        ...
                                        <p className="font-extrabold text-[22px]">{veiculo.motor}</p>
                                    </div>
                                    <div className="w-[100%]">
                                        <p className="font-medium">Combustível:</p>
                                        <p className="font-extrabold text-[22px]">{veiculo.combustivel}</p>
                                    </div>
                                    <div className="w-[100%]">
                                        <p className="font-medium">Câmbio:</p>
                                        <p className="font-extrabold text-[22px]">{veiculo.cambio}</p>
                                    </div>
                                </div>
                                {usuario === 'gerente' && 
                                <button className="w-[100%] bg-[#9A1C1F] text-white font-bold px-[10px] py-[9px] rounded-xl text-[27px] flex flex-row justify-center items-center space-x-4
                                hover:bg-[#D9D9D9] hover:text-[#9A1C1F] hover:stroke-[#9A1C1F] ease-in-out transition-all duration-300">
                                    <svg className="w-[35px] h-auto fill-none" viewBox="0 0 32 34">
                                        <path 
